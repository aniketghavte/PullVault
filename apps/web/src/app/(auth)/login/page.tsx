        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start">
          <div className="space-y-4">
            ...
            <p className="text-bodyLarge text-ink/70">
              This login UI is a simulation theater for the next website build. The rest of
              the app runs off the mock state engine.
            </p>
            <DarkFeatureBand tone="navy" className="py-10 px-6 rounded-lg border border-cardBorder">
              <div className="space-y-2">
                <div className="text-featureHeading font-semibold">Try the full flow</div>
                <p className="text-bodyLarge text-canvas/85">
                  Even without real auth, you can buy packs, reveal cards, trade, and bid.
                </p>
              </div>
            </DarkFeatureBand>
          </div>
          ...
          <ContactFormCard>
            <div className="space-y-6">
              ...
              <div className="text-body text-ink/70">
                New here?{' '}
                <Link href="/signup" className="text-actionBlue underline underline-offset-4 decoration-actionBlue/30 hover:decoration-actionBlue/60">
                  Create an account
                </Link>
              </div>
              <div className="text-micro text-ink/60">
                Tip: Sign in does not contact any backend in this mock build.
              </div>
            </div>
          </ContactFormCard>
        </div>
